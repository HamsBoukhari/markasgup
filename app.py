...
if (trade_msg and sgw_op) and button:
    ...
    # Compare and align 'TrdID' between the original trade message and the output from the second model
    trd_id_output_seq2 = output_sequence_dict2['AllocInstrAlert']['AllExc']['@TrdID']
    if trd_id_value1 != trd_id_output_seq2:
        output_sequence_dict2['AllocInstrAlert']['AllExc']['@TrdID'] = trd_id_value1
